...
///face beauty @{
const char CameraParameters::KEY_SKIN_SOFTEN_LEVEL[] = "skin-soften";
const char CameraParameters::KEY_EYE_ENLARGEMENT_LEVEL[] = "eye-enlargement";
const char CameraParameters::KEY_SLENDER_FACE_LEVEL[] = "slender-face";
const char CameraParameters::KEY_FACE_BEAUTY_ENABLED[] = "face-beauty";
/// @}

///panorama @{
const char CameraParameters::KEY_PANORAMA_STATE[] = "panorama-state";
const char CameraParameters::KEY_PANORAMA_ENABLED[] = "burst-panorama";
/// @}

///wideselfie @{
#if 1
const char CameraParameters::KEY_WIDESELFIE_STATE[] = "wideselfie-state";
const char CameraParameters::KEY_WIDESELFIE_ENABLED[] = "burst-wideselfie";
#endif
/// @}

//bobsong added for nightshot
