...
public:
    ...
    ///panorama @{
    static const char KEY_PANORAMA_STATE[];
    static const char KEY_PANORAMA_ENABLED[];
    /// @}

    ///wideselfie @{
    static const char KEY_WIDESELFIE_STATE[];
    static const char KEY_WIDESELFIE_ENABLED[];
    /// @}

   ///bobsong added for nightshot
   static const char KEY_ENABLENIGHTSHOT[];		//bobsong added
    ...
    static const char KEY_EYE_ENLARGEMENT_LEVEL[];
    static const char KEY_SLENDER_FACE_LEVEL[];
    static const char KEY_FACE_BEAUTY_ENABLED[];
    /// @}
