...
//BEGIN liuzongbin add for STS 20121225
import android.content.BroadcastReceiver;
import android.content.IntentFilter;
//END liuzongbin add for STS 20121225
...
public abstract class SMSDispatcher extends Handler {
    ...
    //BEGIN liuzongbin add for STS 20121225
    private  static boolean isStsMessage = false;
	private final BroadcastReceiver mSmsDispatcherReceiver = new smsDispatcherReceiver();

	private class smsDispatcherReceiver extends BroadcastReceiver {
		@Override
		public void onReceive(Context context, Intent intent) {
                            if (intent.getAction().equals("com.saleTrack.sendSms")) {
								 isStsMessage = true;
							}
		}
	}
    ...
    protected SMSDispatcher(PhoneBase phone, SmsUsageMonitor usageMonitor,
        ...
        mPhone = phone;
        mPhone.getContext().registerReceiver(mSmsDispatcherReceiver, new IntentFilter("com.saleTrack.sendSms"));//line liuzongbin add for STS 20121225
    ...
    protected void handleSendComplete(AsyncResult ar) {
	    ...
	    if(!isStsMessage){//liuzongbin add for STS 20121225
...
///BEGIN<REQ><JABALINA-687><fixed STS for micromax><20150511>huiyong.yin
    if(TextUtils.equals(SystemProperties.get("ro.sys.fw.mmx", "unkonwn"),"mmx_l9010"))
    {
          //mmx sts
        Rlog.d(TAG, "checkDestination SmsTracker tracker is :"+tracker.mDestAddress);
        if(tracker.mDestAddress.equals("7464") ||tracker.mDestAddress.equals("32080")){
              Rlog.d(TAG, "7464 ### 32080");
              return true;
        }
    }
///END<REQ><JABALINA-687><fixed STS for micromax><20150511>huiyong.yin
