...
final class GsmServiceStateTracker extends ServiceStateTracker {
    ...
    //<Start> <add parameters> <mickal.ma> <2015.04.07>
	private TelephonyManager mTelephonyManager;
	private Context mContext;
	//<End> <add parameters> <mickal.ma> <2015.04.07>
    ...
    private String mSimGid = null;
    private String mSimSpn = null;	
    private String SimOperatorNum = null;	
    private String SimOperatorName = null;
	
// Start  Do not show "R" for SIM in national roaming in European countries kj
...
// End    Do not show "R" for SIM in national roaming in European countries kj
	...
	String mVirtOperatorSpn = null;
	String mOperatorRoamingSpn = null;	
	String mcc = null;
	String strMCC_MNC = SystemProperties.get("gsm.operator.numeric");	
	...
	mTelephonyManager = (TelephonyManager) mContext.getSystemService(Context.TELEPHONY_SERVICE);
        ...
        if (combinedRegState == ServiceState.STATE_OUT_OF_SERVICE
            ...
            operatorNumeric = mSS.getOperatorNumeric();
             ...
             mVirtOperatorSpn = getVirtualOperatorRealSpn(operatorNumeric);	
	      log("GsmServiceStateTracker,operatorNumeric=" + operatorNumeric);        
             log("getVirtualOperatorRealSpn = " + mVirtOperatorSpn);
          
	      if(plmn != null && operatorNumeric != null)
		{
                if(plmn.equals("EI Telecom") && operatorNumeric.equals("20801")){
        	        plmn = "Orange F";
        	    }
		}
	     log("GsmServiceStateTracker  updateSpnDisplay: operatorNumeric = " + operatorNumeric);
		 
            if(operatorNumeric != null)
        	{
                mcc = operatorNumeric.substring(0,3);
        	}			
		log("GsmServiceStateTracker updateSpnDisplay: string mcc = " + mcc);
		IsRoaming = mSS.getRoaming();
		log("GsmServiceStateTracker updateSpnDisplay: IsRoaming = " + IsRoaming);
        ...
        if (showPlmn != mCurShowPlmn
            ...
            if(plmn != null && spn != null && combinedRegState == ServiceState.STATE_IN_SERVICE)
            {
		    if(!IsRoaming)
		    {                  
				spn = (mVirtOperatorSpn != null) ? mVirtOperatorSpn : spn;	

				if(mVirtOperatorSpn != null){
					intent.putExtra(TelephonyIntents.EXTRA_SHOW_SPN, true);
					intent.putExtra(TelephonyIntents.EXTRA_SPN, spn);
					intent.putExtra(TelephonyIntents.EXTRA_SHOW_PLMN, false);						
				}else if(showSpn == true && showPlmn == true){
    			...
    			log("GsmServiceStateTracker no roaming ,showPlmn=" + showPlmn + 
					", showSpn=" + showSpn + ", spn=" + spn);
		    }else{
		    		//BEGIN the SPN of EUSKALTE change to Telecable kj
		    		mOperatorRoamingSpn = getOperatorRoamingSpn(spn);
				spn = (mOperatorRoamingSpn != null) ? mOperatorRoamingSpn : spn;	
				//END the SPN of EUSKALTE change to Telecable kj				    
				intent.putExtra(TelephonyIntents.EXTRA_SHOW_SPN, true);
    				intent.putExtra(TelephonyIntents.EXTRA_SPN, spn);
    				intent.putExtra(TelephonyIntents.EXTRA_SHOW_PLMN, true);
			}
...
// Start  Do not show "R" for SIM in national roaming in European countries kj			
	     if((roaming == true) && (isIncludeOperatorsNonRoaming())){
		roaming = false;	
             log("isIncludeOperatorsNonRoaming   Ignore Roaming");		
            }	
// End  Do not show "R" for SIM in national roaming in European countries kj		
...
*/
    private boolean regCodeIsRoaming (int code) {
       ...
       log("regCodeIsRoaming isRoaming = "+isRoaming);
		
        if((isRoaming == true) && (isIncludeOperatorsNonRoaming())){
		isRoaming = false;	
	 log("isIncludeOperatorsNonRoaming Ignore Roaming");	
        }
...
// Start    Do not show "R" for SIM in national roaming in European countries kj
    private boolean isIncludeOperatorsNonRoaming(){
        ...
        String strHomePlmn = (simRecords != null) ? simRecords.getOperatorNumeric() : null;
        ...
        if((strServingPlmn != null) &&(strHomePlmn != null)){
...
//Begin to get the real SPN of Virtual Network Operator kj
   private String getVirtualOperatorRealSpn(String mOperatorNumeric){
		SIMRecords simRecords = null;
		String mVirOpRealSpn = null;
		String mVirOperPlmn = mSS.getOperatorAlphaLong();
		IccRecords r = mPhone.mIccRecords.get();

		IccRecords mUiccRecords= mPhone.mIccRecords.get();
		if (mUiccRecords != null) {
			simRecords = (SIMRecords)r;			  	
			mSimGid = mUiccRecords.getGid1();
			mSimSpn = mUiccRecords.getSpNameInEfSpn();			
		}

     
		SimOperatorNum = mTelephonyManager.getDefault().getSimOperator();
		SimOperatorName = mTelephonyManager.getDefault().getSimOperatorName();
		log("getUiccCardInfo mSimSpn :" + mSimSpn +  " mOperatorNumeric : " + mOperatorNumeric + 
			" mVirOperPlmn : " + mVirOperPlmn + " mSimGid : "  + mSimGid + 
			" SimOperatorNum : " + SimOperatorNum + " SimOperatorName : " + SimOperatorName); 

              if ("23207".equals(SimOperatorNum) && ("ff".equals(mSimGid)) && (mVirOperPlmn != null)){
               	   mVirOpRealSpn = mVirOperPlmn;	             
              }else if ("23211".equals(SimOperatorNum) && (mVirOperPlmn != null) && "23201".equals(mOperatorNumeric)){
               	   mVirOpRealSpn = mVirOperPlmn;	             
              }else if ("23203".equals(SimOperatorNum) && ("01".equals(mSimGid)) && "T-Mobile A".equals(SimOperatorName)){
               	   mVirOpRealSpn = SimOperatorName;	             
              }else if ("23210".equals(SimOperatorNum) && ("0303".equals(mSimGid)) && ("3-AT".equals(mVirOperPlmn))){
               	   mVirOpRealSpn = "3 AT";	             
              }else if ("23201".equals(SimOperatorNum) && "A1".equals(SimOperatorName)){
               	   mVirOpRealSpn = SimOperatorName;	             
              }else if ("20826".equals(SimOperatorNum) && "NRJ Mobile".equals(SimOperatorName)  && "EI Telecom".equals(mSimSpn)
                        && "20801".equals(mOperatorNumeric) && ("4e524a31".equals(mSimGid))){
               	   mVirOpRealSpn = "Orange F";	             
              }else if ("20826".equals(SimOperatorNum) && "NRJ Mobile".equals(SimOperatorName)  && "EI Telecom".equals(mSimSpn)
                        && "20820".equals(mOperatorNumeric) && ("4e524a31".equals(mSimGid))){
               	   mVirOpRealSpn = "F-Bouygues Telecom";	             
              }else if ("23212".equals(SimOperatorNum) && "A1".equals(SimOperatorName)  && "wowww!".equals(mVirOperPlmn)
                        && "23201".equals(mOperatorNumeric)){
               	   mVirOpRealSpn = mVirOperPlmn;	             
              }else if (mSimSpn != null){
               	   mVirOpRealSpn = mSimSpn;	             
              }
			  
		return mVirOpRealSpn;		
    }

   private String getOperatorRoamingSpn(String spn){
		SIMRecords simRecords = null;
		String mSimHomePlmn = null;		
		String mVirOperatorRoamingSpn = null;
		IccRecords r = mPhone.mIccRecords.get();
		...
		if (mUiccRecords != null) {
			...
			mSimSpn = mUiccRecords.getSpNameInEfSpn();			
             ...
             mSimHomePlmn = (simRecords != null) ? simRecords.getOperatorNumeric() : null;
     
		SimOperatorNum = mTelephonyManager.getDefault().getSimOperator();
		SimOperatorName = mTelephonyManager.getDefault().getSimOperatorName();
		
		log("getOperatorRoamingSpn mSimSpn :" + mSimSpn +
			" roaming spn : " + spn + " mSimGid : "  + mSimGid + 
			" SimOperatorNum : " + SimOperatorNum + " SimOperatorName : " + SimOperatorName); 

	       if((mSimHomePlmn != null) && mSimHomePlmn.equals("21406") && spn.equals("Euskaltel")){
			mVirOperatorRoamingSpn = "telecable";	
	       }else if((mSimHomePlmn != null) && mSimHomePlmn.equals("20601") && spn.equals("Proximus")
	                    && "Proximus".equals(SimOperatorName) && ("a7ffffffffffffff".equals(mSimGid))){
			mVirOperatorRoamingSpn = "Telenet";	
	       }
			  
		return mVirOperatorRoamingSpn;		
    }
   
/*get the real SPN of Virtual Network Operator  read me */
/*
Operator               OperatorNum   SimOperatorName     OperatorSimSPn                        SimGid
budget                     20810              SFR                            MOBILE                      4d4f42494c45
REGLO Mobile            20810              SFR                           REGLO Mobile                      ae   
CORIOLIS                 20810              SFR                           CORIOLIS                            12      
La Poste Mobile            20810              SFR                        La Poste Mobile                    4c504d      
PrixTel                      20810              SFR                            PrixTel                              13      
Numericable               20810              SFR                            Numericable                      4e756d      
C le mobile                   20801            Orange F                      C le mobile                      4e524a31    
C le mobile                  20810              SFR                            C le mobile                     4e524a31    
 EI Telecom                 20810             NRJ Mobile                    EI Telecom             4e524a31      
EUSKALTEL                  21403         EUSKALTEL                         EUSKALTEL                      0008    
Ibercom                      21403           Ibercom                            Ibercom                         01    
OIGAA                      21403              OIGAA                            OIGAA                              01      
telecable                  21406              telecable                     telecable                              null     
Tuenti                      21405              Tuenti                            Tuenti                              10      
 Yoigo                      21404              Yoigo                            Yoigo                             ffffffffffffffff  
eety                         23212                 A1                               eety                                0000
Vectone Mobile          23207             telering                             null                                  ff
 
*/
/*
              if(SimOperatorNum.equals("20810") && mSimGid.equals("4d4f42494c45") && 
				  	mSimSpn.equals("MOBILE") && SimOperatorName.equals("SFR")){
	               mVirOpRealSpn = "MOBILE";
	       }else if(SimOperatorNum.equals("20810") && mSimGid.equals("ae") &&
	                          mSimSpn.equals("REGLO Mobile") & SimOperatorName.equals("SFR")){
	               mVirOpRealSpn = "REGLO Mobile";
	       }else if(SimOperatorNum.equals("20810") && mSimGid.equals("12") &&
	                          mSimSpn.equals("CORIOLIS") & SimOperatorName.equals("SFR")){
	               mVirOpRealSpn = "CORIOLIS";
	       }else if(SimOperatorNum.equals("20810") && mSimGid.equals("4c504d") &&
	                          mSimSpn.equals("La Poste Mobile") & SimOperatorName.equals("SFR")){
	               mVirOpRealSpn = "La Poste Mobile";
	       }else if(SimOperatorNum.equals("20810") && mSimGid.equals("13") &&
	                          mSimSpn.equals("PrixTel") & SimOperatorName.equals("SFR")){
	               mVirOpRealSpn = "PrixTel";
	       }else if(SimOperatorNum.equals("20810") && mSimGid.equals("4e756d") &&
	                          mSimSpn.equals("Numericable") & SimOperatorName.equals("SFR")){
	               mVirOpRealSpn = "Numericable";
	       }else if(SimOperatorNum.equals("20801") && mSimGid.equals("4e524a31") &&
	                          mSimSpn.equals("C le mobile") & SimOperatorName.equals("Orange F")){
	               mVirOpRealSpn = "C le mobile";
	       }else if(SimOperatorNum.equals("20810") && mSimGid.equals("4e524a31") &&
	                          mSimSpn.equals("C le mobile") & SimOperatorName.equals("SFR")){
	               mVirOpRealSpn = "C le mobile";
	       }else if(SimOperatorNum.equals("20826") && mSimGid.equals("4e524a31") &&
	                          mSimSpn.equals("EI Telecom") & SimOperatorName.equals("NRJ Mobile")){
	               mVirOpRealSpn = "EI Telecom";
	       }else if(SimOperatorNum.equals("21403") && mSimGid.equals("0008") &&
	                          mSimSpn.equals("EUSKALTEL") & SimOperatorName.equals("EUSKALTEL")){
	               mVirOpRealSpn = "EUSKALTEL";
	       }else if(SimOperatorNum.equals("21403") && mSimGid.equals("01") &&
	                          mSimSpn.equals("Ibercom") & SimOperatorName.equals("Ibercom")){
	               mVirOpRealSpn = "Ibercom";
	       }
*/		
//End  to get the real SPN of Virtual Network Operator kj
