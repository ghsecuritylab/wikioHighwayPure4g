...
// Start NRJ/EIT telecom issue kj
import com.android.internal.telephony.Phone;
import com.android.internal.telephony.PhoneFactory;
// End   NRJ/EIT telecom issue kj

import com.android.internal.telephony.PhoneConstants;     /*** MVNO-API */
...
*/
	  if(mSpn != null && !mSpn.equals("")){
	        	setVoiceMailByCountry(operator,mSpn);
	  }
// End   NRJ/EIT telecom issue kj

//modify for EUSKALTEL wrong Title display kj
	if(mSpn != null && !mSpn.equals("EUSKALTEL")){		
...
// Start NRJ/EIT telecom issue kj
	private boolean isEITelecom(String mccmnc,String spn)
	{
		log("setVoiceMailByCountry mccmnc= "+ mccmnc + "spn ="+spn);
		if((mccmnc.equals("20826")&& spn.equals("EI Telecom"))
			||(mccmnc.equals("20801")&& spn.equals("Orange F"))
			||(mccmnc.equals("20801")&& spn.equals("C le mobile"))		
			||(mccmnc.equals("20810")&& spn.equals("C le mobile"))){
			return true;
		}else{
			return false;
		}
	}
	private void setVoiceMailByCountry (String mccmnc,String spn) {
		log("setVoiceMailByCountry mccmnc= "+ mccmnc + "spn = "+spn);
		log("setVoiceMailByCountry mVoiceMailNum= "+ mVoiceMailNum);		
		if ((TextUtils.isEmpty(mVoiceMailNum) || mVoiceMailNum.equals("777"))
			&& mVmConfig.containsCarrier(mccmnc)&&isEITelecom(mccmnc,spn)){
			isSetByCountry = true;
			mVoiceMailNum = mVmConfig.getVoiceMailNumber(mccmnc);			
			mVoiceMailTag = mVmConfig.getVoiceMailTag(mccmnc);
		    log("setVoiceMailByCountry voiceMailNum= "+mVoiceMailNum + "voiceMailTag ="+mVoiceMailTag); 
		}
	}
...
*/
        } else if (isOnMatchingPlmn(plmn)||(!mPhone.getServiceState().getRoaming())) {
// End   NRJ/EIT telecom issue kj       
            rule = SPN_RULE_SHOW_SPN;
        ...
        switch(mSpnState){
            ...
            case READ_SPN_3GPP:
                if (ar != null && ar.exception == null) {
                     ...
                     * MVNO-API
                    */
                    mSpNameInEfSpn = IccUtils.adnStringFieldToString(data, 1, data.length - 1);
    ...
    */
    ...
    public String getMvnoMatchType() {
        ...
        String GID1 = getGid1();
        String MCCMNC= getOperatorNumeric();
        if (DBG) log("getMvnoMatchType(): imsi = " + IMSI + ", mccmnc = " + MCCMNC + ", spn = " + SPN + ", PNN = " + PNN + ", GID1 = " + GID1);
