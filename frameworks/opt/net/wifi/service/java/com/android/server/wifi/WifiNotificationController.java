...
import android.media.RingtoneManager;//LINE<JABALL-159><20150410><WLAN network noticfication have no rings>huiyong.yin
...
final class WifiNotificationController {
     ...
     */
    private static final int NUM_SCANS_BEFORE_ACTUALLY_SCANNING = 2;//3;//LINE<BUG><JABALL-77><WiFi Notification pop slow>huiyong.yin
    /**
    ...
    private void setNotificationVisible(boolean visible, int numNetworks, boolean force,
        ...
        if (visible) {
          ...
          //BEGIN<JABALL-159><20150410><WLAN network noticfication have no rings>huiyong.yin
          ...
          //END<JABALL-159><20150410><WLAN network noticfication have no rings>huiyong.yin
