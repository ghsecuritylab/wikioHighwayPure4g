...
ifeq ($(NXP_SMARTPA_SUPPORT),tfa9890)
LOCAL_C_INCLUDES += \
        vendor/tinno/tfa9890/interface
endif
...
#<BEGIN><FFBAKK-105><2014.01.12>add for tfa9890-pa;yangliang
#ifneq ($(filter l9010,$(TARGET_PRODUCT)),)
#    LOCAL_CFLAGS  += -DTARGET_L9010
#endif
ifneq ($(TARGET_PRODUCT),)
        temp := $(shell echo $(TARGET_PRODUCT) | tr a-z A-Z)
        custom_pro := $(shell echo  $(temp) | cut -c1-5)
	LOCAL_CFLAGS  += -DTARGET_$(custom_pro)
endif
