...
#Tinno:CJ getprop("ro.build.fingerprint") change to file_getprop("/system/build.prop","ro.build.fingerprint") for more package update in one time
  def AssertSomeFingerprint(self, *fp):
    ...
    cmd = (
           ...
           'device has " + file_getprop("/system/build.prop","ro.build.fingerprint") + ".");'
           ) % (" or ".join(fp),)
    self.script.append(cmd)
