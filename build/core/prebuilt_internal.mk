...
ifeq ($(LOCAL_CERTIFICATE),)
  ...
  ifeq ($(SIGNATURE_CUSTOMIZATION),true) #liuzongbin add for sign key 2014.10.17
    LOCAL_CERTIFICATE := $(SRC_TARGET_DIR)/product/security/$(SIGNATURE_CUSTOMIZATION_DIR)/$(LOCAL_CERTIFICATE)
  else
