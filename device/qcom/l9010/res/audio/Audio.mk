...
LOCAL_PATH := device/qcom/l9010/res/audio
...
PRODUCT_COPY_FILES += \
	...
	$(LOCAL_PATH)/notifications/Graceful.ogg:system/media/audio/notifications/Graceful.ogg \
	...
	$(LOCAL_PATH)/notifications/Musicbox.ogg:system/media/audio/notifications/Musicbox.ogg \
	$(LOCAL_PATH)/notifications/Pure.ogg:system/media/audio/notifications/Pure.ogg \
	$(LOCAL_PATH)/notifications/Tambourine.ogg:system/media/audio/notifications/Tambourine.ogg \
	$(LOCAL_PATH)/notifications/Whistle.ogg:system/media/audio/notifications/Whistle.ogg \
	$(LOCAL_PATH)/notifications/Lightly.ogg:system/media/audio/notifications/Lightly.ogg \
	...
	#$(LOCAL_PATH)/mmsnotifications/Amenity.ogg:system/media/audio/mmsnotifications/Amenity.ogg \
	#$(LOCAL_PATH)/mmsnotifications/Bell.ogg:system/media/audio/mmsnotifications/Bell.ogg \
	#$(LOCAL_PATH)/mmsnotifications/Horizon.ogg:system/media/audio/mmsnotifications/Horizon.ogg \
	#$(LOCAL_PATH)/mmsnotifications/Tambourine.ogg:system/media/audio/mmsnotifications/Tambourine.ogg \
	#$(LOCAL_PATH)/mmsnotifications/Pure.ogg:system/media/audio/mmsnotifications/Pure.ogg \
	...
	#$(LOCAL_PATH)/ringtones/Acoustic_Guitar.ogg:system/media/audio/ringtones/Acoustic_Guitar.ogg \
	#$(LOCAL_PATH)/ringtones/Spar.ogg:system/media/audio/ringtones/Spar.ogg \
	#$(LOCAL_PATH)/ringtones/Xylophone.ogg:system/media/audio/ringtones/Xylophone.ogg \
	#$(LOCAL_PATH)/ringtones/Yearn_for.ogg:system/media/audio/ringtones/Yearn_for.ogg \
